...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2018 at 08:39 PM
...
ALTER TABLE `grades`
  ADD PRIMARY KEY (`id`),
  ADD KEY `Grades_Courses` (`course_id`),
  ADD KEY `Grades_Students` (`student_id`);
...
--
ALTER TABLE `grades`
  ADD CONSTRAINT `Grades_Courses` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Grades_Students` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
